...
if __name__ == "__main__":
    ...
    alipay = AliPay(
        appid="2017092808973751",  # 2017092808973751 2016080700190395
        app_notify_url="http://116.62.210.69:8001/alipay/return/",
        app_private_key_path="../trade/keys/private_2048.txt",
        alipay_public_key_path="../trade/keys/alipay_key_2048.txt",  # 支付宝的公钥，验证支付宝回传消息使用，不是你自己的公钥,
        debug=False,  # 默认False,
        return_url="http://116.62.210.69:8001/alipay/return/"
    )
