...
*/
    ...
    Blockly.Blocks['yak_transform_translate3'] = {
        init: function () {
            this.appendValueInput("v_x")
                .setCheck(null)
                .appendField("translate (");
            this.appendValueInput("v_y")
                .setCheck(null)
                .appendField(",");
            this.appendValueInput("v_z")
                .setCheck(null)
                .appendField(",");
    ...
    Blockly.Blocks["yak_shape_ellipseMode"] = {
        init: function () {
            ...
            this.setPreviousStatement(true, null);
            this.setNextStatement(true, null);
            this.setColour(YAK_SHAPE_COLOR);
    ...
    Blockly.Blocks["yak_color_stroke"] = {
        init: function () {
            ...
            this.setPreviousStatement(true, null);
            this.setNextStatement(true, null);
            this.setColour(YAK_COLOR_COLOR);
    ...
    // yak math
    YAK_MATH_COLOR="#7c31f8"
    Blockly.Blocks['yak_math_createVector2'] = {
        init: function () {
            this.appendValueInput("v_width")
                .setCheck("Number")
                .appendField("createVector (");
            this.appendValueInput("v_height")
                .setCheck("Number")
    ...
    Blockly.Blocks["yak_image_loadImage"] = {
        init: function () {
            ...
            this.setColour(YAK_IMAGE_COLOR);
            this.setTooltip("");
            this.setHelpUrl("")
        }
    };
    Blockly.Blocks['yak_image_image'] = {
        init: function () {
            this.appendValueInput("v_width")
                .setCheck("Number")
                .appendField("image (");
    ...
    Blockly.Blocks["yak_environment_frameRate"] = {
        init: function () {
            ...
            this.setPreviousStatement(true, null);
            this.setNextStatement(true, null);
            this.setColour(YAK_EVENT_COLOR);
